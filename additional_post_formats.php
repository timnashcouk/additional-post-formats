...
function tn_add_post_formats()
{
	...
	$additional_post_formats = array();
	if(!empty($_wp_theme_features['additional-post-formats'])){
		$additional_post_formats = $_wp_theme_features['additional-post-formats'];
	}
	$post_formats = $_wp_theme_features['post-formats'][0];
	if(is_array($additional_post_formats) && !empty($additional_post_formats)){
...
function tnapf_meta_callback($post)
{
	...
	//$sites_known_formats = array();
	$sites_known_formats = tnapf_get_post_format_slugs();
	
	$themes_known_formats = get_theme_support( 'additional-post-formats' );
	$post_formats = array_intersect($themes_known_formats[0],$sites_known_formats);
